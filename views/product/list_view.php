<div class="top_page">
     <div class="grid">
          ...
          <?php if($data['cat']['parentid']>0) { ?>
          <div class="row">
             <div class="col-md-12">
                  <h3 class="catprod_title"><?php echo $data['cat']['title_vn'];?></h3> 
                  <div class="catprod_mota"><?php echo $data['cat']['sdescription'];?></div>        
             </div>
          </div>
          <img class="catprod_images" src="<?=BASE_URL."data/Catelog/".$data['cat']['images']?>" />
