...
?>
<a href="tintuc/danhmuc/<?=$item["Id"]."-".unicode_convert($item['title_vn']) ?>" <?php if($data["idatv"]==$item["Id"]) echo "class='active'"; ?>><?=$item['title_vn'] ?></a>
<?php }} ?>
</div>
<!------seacrch--------->
<div class="seacrh">
<form action="<?=BASE_URL?>tintuc/timkiem.htm" method="post">
<input type="text" onblur="if (this.value=='') this.value='Tìm kiếm';" onfocus="if (this.value=='Tìm kiếm') this.value='';" class="searchInput" id="tukhoa" value="Tìm kiếm" name="tukhoa">
<input  type="image" src="<?=USER_PATH_IMG ?>search_bt.jpg" />
</form>
</div>
<div class="lmod-link">
<ul class="noli">
    <li><a href="<?=BASE_URL ?>"><img src="<?=USER_PATH_IMG ?>ico-letter.png" alt="">  &nbsp; Bệnh án điện tử</a></li>
    <li><a href="<?=BASE_URL ?>dat-lich-kham.html"><img src="<?=USER_PATH_IMG ?>icon-boking.png" alt=""> &nbsp; Đặt lịch khám </a></li>
    <li><a href="<?=BASE_URL ?>dich-vu.html"><img src="<?=USER_PATH_IMG ?>icon-repaid.png" alt=""> &nbsp; Dịch vụ prepaid</a></li>
</ul>
</div>
<div class="qc2-ben">
<?php
...
?>
		<div class="news">
			<a href="tintuc/chitiet/<?php echo $item['Id']?>-<?php echo unicode_convert(stripslashes($item['title_'.lang]))?>" title="<?php echo stripslashes($item['title_'.lang])?>"><img src = "<?=PATH_IMG_NEWS.$item['images']?>" width = "120" height="90" class="img_left" alt="<?php echo $item['title_'.lang]?>"></a>
            ...
            <div class="xemtep">
                <a href="tintuc/chitiet/<?php echo $item['Id']?>-<?php echo unicode_convert(stripslashes($item['title_'.lang]))?>l" title="<?php echo stripslashes($item['title_'.lang])?>">Chi tiết</a>
...
<div id="right">
<h4 class="tieude">Ý kiến khách hàng</h4>
...
<a href="comment/chitiet/<?php echo $item['Id']?>-<?php echo unicode_convert(stripslashes($item['title_'.lang]))?>"><?=$item["title_vn"] ?></a>
<?=limit_text($item["content_vn"],300); ?>
</div>
<?php }} ?>
</div>

<div class="space_10"></div>
<h4 class="tieude">Đăng ký nhận bản tin</h4>
<div class="wget-content">
<div class="wrap03">
    Vui lòng nhập email của bạn để nhận các bản tin của chúng tôi
</div>
<div class="newsletter-frm">
    <input type="text" class="riTextBox" size="20" maxlength="50" name="emailgui" id="emailgui">
    <input type="button" class="nl-submit" id="ctl00_cntMain_Newsletter1_btnSend"  value="Gửi" name="btnregisteremail">
</div>
<div class="wrap02">
