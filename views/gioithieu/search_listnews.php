...
<P style="margin-bottom:10px;">Tìm thấy <b><?=$data["count"] ?></b> kết quả với từ khóa "<?=$_POST["tukhoa"] ?>"</P>
<?php
...
?>
		<div class="news">
			<a href="gioithieu/chitiet/<?php echo $item['Id']?>-<?php echo unicode_convert(stripslashes($item['title_'.lang]))?>" title="<?php echo stripslashes($item['title_'.lang])?>">
			...
			<h1><a href="gioithieu/chitiet/<?php echo $item['Id']?>-<?php echo unicode_convert(stripslashes($item['title_'.lang]))?>" title="<?php echo stripslashes($item['title_'.lang])?>"><?php echo stripslashes($item['title_'.lang])?></a></h1>
			<p><?php echo stripslashes($item['description_'.lang]);?> </p>
            <div class="xemtep">
                <a href="gioithieu/chitiet/<?php echo $item['Id']?>-<?php echo unicode_convert(stripslashes($item['title_'.lang]))?>" title="<?php echo stripslashes($item['title_'.lang])?>"><?=CHITIET ?></a>
