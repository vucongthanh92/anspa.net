...
<h1><img src = '<?php echo ADMIN_PATH_IMG;?>s_db.png'> Sửa dịch vụ</h1>
<br/>
<hr/>

<form action = '<?php echo BASE_URL_ADMIN;?>catservices/edit/<?php echo $data['info']['Id']?>' method = 'post' enctype = "multipart/form-data">
<table>
<?php
