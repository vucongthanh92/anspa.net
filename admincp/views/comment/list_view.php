<h1><img src = '<?php echo ADMIN_PATH_IMG;?>s_db.png'> Ý kiến khách</h1>
<br/>
<div style="clear:both"></div>
<hr/>
<img src = '<?php echo ADMIN_PATH_IMG;?>b_insrow.png'><a href = '<?php echo BASE_URL_ADMIN;?>comment/add'><span class = 'them'> <?php echo G_ADD; ?></span></a>
<hr/>
...
<table>
	...
	else //neu co du lieu xuat du lieu ra
	{
		...
		<tr>
			...
			<?php 
            if($item['ticlock'] == "1"){
                echo "<div id = '".$item['Id']."'><a href = 'javascript:ticlockactive(\"".TBL_COMMENT."\",\"ticlock\",\"".$item['Id']."\",\"0\",\"".BASE_URL_ADMIN."\");' title = 'Bỏ khóa'><img src = '".ADMIN_PATH_IMG."visible.gif'></a></div>";
            }else{
                echo "<div id = '".$item['Id']."'><a href = 'javascript:ticlockactive(\"".TBL_COMMENT."\",\"ticlock\",\"".$item['Id']."\",\"1\",\"".BASE_URL_ADMIN."\");' title = 'Khóa tin'><img src = '".ADMIN_PATH_IMG."invisible.gif'></a></div>"; 
            }
            ?>
            </td>
