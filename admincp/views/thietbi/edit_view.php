<h1><img src = '<?php echo ADMIN_PATH_IMG;?>s_db.png'> Sửa thiết bị</h1>
<br/>
<hr/>
...
<form name = "frm" action = '<?php echo BASE_URL_ADMIN;?>thietbi/edit/<?php echo $data['info']['Id'];?>' method = 'post' enctype = "multipart/form-data" onsubmit = "return checkform();">
<table>
