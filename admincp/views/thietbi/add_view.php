<h1><img src = '<?php echo ADMIN_PATH_IMG;?>s_db.png'> Thêm thiết bị</h1>
...
<form name = "frm" action = '<?php echo BASE_URL_ADMIN;?>thietbi/add' method = 'post' enctype = "multipart/form-data" onsubmit = "return checkform();">
