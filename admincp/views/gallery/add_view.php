...
<h1><img src = '<?php echo ADMIN_PATH_IMG;?>s_db.png'> Thêm Chủ đề album</h1>
<br/>
<hr/>

<form action = '<?php echo BASE_URL_ADMIN;?>gallery/add' method = 'post' enctype = "multipart/form-data">
<table>
<?php
