<h1><img src = '<?php echo ADMIN_PATH_IMG;?>s_db.png'> Sửa bải viết dịch vụ</h1>
<br/>
<hr/>
...
<form name = "frm" action = '<?php echo BASE_URL_ADMIN;?>services/edit/<?php echo $data['info']['Id'];?>' method = 'post' enctype = "multipart/form-data" onsubmit = "return checkform();">
<table>
