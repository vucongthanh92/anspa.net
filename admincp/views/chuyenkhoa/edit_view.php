...
<h1><img src = '<?php echo ADMIN_PATH_IMG;?>s_db.png'> Sửa chuyên khoa</h1>
<br/>
<hr/>

<form action = '<?php echo BASE_URL_ADMIN;?>chuyenkhoa/edit/<?php echo $data['info']['Id']?>' method = 'post' enctype = "multipart/form-data">
<table>
<?php
