...
<h1><img src = '<?php echo ADMIN_PATH_IMG;?>s_db.png'> Thêm chuyên khoa</h1>
<br/>
<hr/>

<form action = '<?php echo BASE_URL_ADMIN;?>chuyenkhoa/add' method = 'post' enctype = "multipart/form-data">
<table>
<?php
